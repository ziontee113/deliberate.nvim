...
local text_change_callback = function(line)
    local content = require("stormcaller.lib.pseudo_classes.mixer").translate_alias_string(line)
    require("stormcaller.lib.pseudo_classes.manager").update(content)
    require("stormcaller.lib.indicator").highlight_pseudo_classes()
end
