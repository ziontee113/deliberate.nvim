...
describe("get_tag_identifier_node()", function()
    ...
    it("works for `jsx_element` node type", function()
        ...
        helpers.node_has_text(tag_idenifier_node, "p")
    end)
    ...
    it("works for `jsx_self_closing_element` node type", function()
        ...
        local tag_idenifier_node = lib_ts_tsx.get_tag_identifier_node(node)
        helpers.node_has_text(tag_idenifier_node, "OtherComponent")
    end)
end)
...
describe("get_className_property_string_node()", function()
    ...
    it("works", function()
        ...
        helpers.node_has_text(className_string_node, [["h-screen w-screen bg-zinc-900"]])
    end)
end)
...
describe("get_html_node()", function()
    ...
    it("works", function()
        ...
        helpers.node_has_text(node_at_cursor, "Contacts")

        local html_node = lib_ts_tsx.get_html_node(node_at_cursor)
        helpers.node_has_text(html_node, "<li>Contacts</li>")
    end)
end)
...
describe("get_first_closing_bracket()", function()
    ...
    it("works", function()
        ...
        helpers.node_has_text(first_bracket_node:parent(), "<li>")
        helpers.node_has_text(first_bracket_node:parent():parent(), "<li>Contacts</li>")
    end)
end)
...
describe("get_html_children()", function()
    ...
    it("works", function()
        ...
        local html_node = lib_ts_tsx.get_html_node(ts_utils.get_node_at_cursor())
        helpers.node_first_line(html_node, "<ul>")

        local html_children = lib_ts_tsx.get_html_children(html_node)
        helpers.node_has_text(html_children[1], "<li>Log In</li>")
        helpers.node_has_text(html_children[2], "<li>Sign Up</li>")
    end)
end)
...
describe("get_html_siblings()", function()
    ...
    it("works", function()
        ...
        helpers.node_has_text(next_siblings[1], "<li>FAQ</li>")
        helpers.node_has_text(next_siblings[2], "<OtherComponent />")

        local previous_siblings = lib_ts_tsx.get_html_siblings(html_node, "previous")
        helpers.node_first_line(previous_siblings[1], "<li>")
        helpers.node_has_text(previous_siblings[2], "<li>Home</li>")
    end)
end)
